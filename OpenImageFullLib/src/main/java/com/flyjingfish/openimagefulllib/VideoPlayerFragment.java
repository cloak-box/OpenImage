...
public class VideoPlayerFragment extends BaseImageFragment<LoadingView> {
  ...
  protected void startPlay() {
    ...
    videoPlayer.setSeekOnStart(
        RecordPlayerPosition.INSTANCE.getPlayPosition(requireActivity(), beanId));
  ...
  public void onPause() {
    ...
    if (playerKey != null) {
      ...
      RecordPlayerPosition.INSTANCE.setPlayPosition(
          requireActivity(), beanId, videoPlayer.getCurrentPositionWhenPlaying());
    }
  }
  ...
  public View getExitImageView() {
    if (videoPlayer instanceof ScaleOpenImageVideoPlayer) {
      ((ScaleOpenImageVideoPlayer) videoPlayer).getAttacher().setExitMode(true);
    }
